...
router.route('/').get(service.getProfiles)
// .post(AuthMiddleware.protect, service.createProfile); // ideally this would never be used as profiles should be created during registration
router
  .route('/:id')
