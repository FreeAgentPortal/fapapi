...
router.route('/trigger-scheduled-payments').post(AuthMiddleware.protect, AuthMiddleware.authorizeRoles(['admin', 'internal']) as any, service.triggerScheduledPayments);
